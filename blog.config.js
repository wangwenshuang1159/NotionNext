...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Embodied Blog', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '团队简介', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-flame-eta.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '具身智能, 博客', // 网站关键词 英文逗号隔开
